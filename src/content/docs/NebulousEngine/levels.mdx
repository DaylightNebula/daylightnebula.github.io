...
## In Action
Here is a levels example, where you can swap between the two states with two different colored cubes by pressing B and space.
<div>
    <canvas id="bevy"></canvas>
    <script type="module" src="/levels-example.js" />
</div>
